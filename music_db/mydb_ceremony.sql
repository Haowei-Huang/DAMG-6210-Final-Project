...
CREATE TABLE `ceremony` (
  `CeremonyID` smallint unsigned NOT NULL AUTO_INCREMENT,
  `CeremonyName` varchar(45) NOT NULL,
  PRIMARY KEY (`CeremonyID`),
  UNIQUE KEY `CeremonyID_UNIQUE` (`CeremonyID`)
...
INSERT INTO `ceremony` VALUES (1,'Mercury Prize'),(2,'Billboard Music Awards'),(3,'American Music Awards'),(4,'Grammy Awards');
