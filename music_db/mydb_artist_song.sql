...
CREATE TABLE `artist_song` (
  ...
  PRIMARY KEY (`FK_ARTIST`,`FK_SONG`),
  KEY `indxSong_idx` (`FK_SONG`),
  CONSTRAINT `indxArtist_Song_Artist` FOREIGN KEY (`FK_ARTIST`) REFERENCES `artist` (`ArtistID`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `indxArtist_Song_Song` FOREIGN KEY (`FK_SONG`) REFERENCES `song` (`SongID`) ON DELETE CASCADE ON UPDATE RESTRICT
...
INSERT INTO `artist_song` VALUES (1,1),(1,2),(1,3),(7,4);
